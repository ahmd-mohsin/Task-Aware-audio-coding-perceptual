...
# # Define the directory to change to before loading modules/files
# temp_dir = "/home/ahsan/Ahsan/PhD work/AAAI_2025_PAPER/Task-Aware-audio-coding-perceptual/sgmse/"
...
def batch_reconstruct_waveform(magnitude_batch, phase_batch, sample_rate, n_fft=2048, hop_length=512, win_length=2048, window='hann'):
    ...
    return torch.stack(reconstructed_waveforms, dim=0)  
...
def task_aware(noisy_audio_batch, clean_audio_batch):
    ...
    y_hat = enhance_audio(
            ...
            y=reconstructed_noisy_waveforms,
            sr=48000,
            device="cuda",
            sampler_type="pc",
            corrector="ald",
